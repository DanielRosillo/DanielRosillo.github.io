...
Implementaciones sobre búsqueda no informada en JAVA, usando un enfoque funcional<br />
<br />
...
<br />
&nbsp;&nbsp;&nbsp; Node -&gt; Una estructura de datos que tiene lugar en el árbol;<br />
...
<br />
Los arboles son estructuras de datos complejas que nos permiten modelar el mundo, siguiendo ciertas restricciones adaptadas de la propia naturaleza del problema.<br />
<br />
...
Los arboles con los que trabajaremos contienen una raíz destacada la cual es el origen del estado, por lo cual solo hay un camino origen asociado a un estado viniendo desde otro.<br />
<a name='more'></a><br />
