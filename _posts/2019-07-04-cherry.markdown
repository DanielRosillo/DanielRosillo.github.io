...
<br />
&nbsp;&nbsp;&nbsp; Node -&gt;<p> Una estructura de datos que tiene lugar en el árbol;<br />
...
<br />
Las estructuras lógicas de tipo "Árbol", nos permiten modelar soluciones a problemas, donde lo que se busca el la mejor solución de un conjunto de posibles estados.<br />
<br />
